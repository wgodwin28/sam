...
## Enrollment over time (Display 3)
...
# Baseline characteristics (Display 5)
```{r, echo=F, message=F, warning=F}
...
## Weight versus height (Display 10)
...
# Malaria-rapid diagnostic test results (Display 13)
```{r, echo=F}
# number of csps
...
# General Follow-up
## Actual to expected ratio-Vital status form (Display 15)
```{r, echo=F}
...
## Actual to expected ratio-Anthro form (Display 16)
```{r, echo=F}
...
# Adverse events
## Total participants displaying symptoms (Display 17)
```{r, echo=F, warning=F}
# tabulate symptoms
...
## Total participants visiting health facility (Display 18)
```{r, echo=F, warning=F}
...
## Total participants hospitalized (Display 18)
```{r, echo=F}
# tabulate visits and reason for visits
pluck(df_list, "followup") %>%
...
### List of participants hospitalized for malnutrition lacking a discharge form
```{r, echo=F}
...
## Other reasons for discharge (Display 19)
```{r, echo=F}
# list other reasons
pluck(df_list, "discharge") %>%
...
## Anthro and Treatment weight discrepancy (>0.5 kg difference) (Display 22)
```{r, echo=F, message=F, warning=F}
